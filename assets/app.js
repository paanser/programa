// Pure color utilities — defined at module scope so they're accessible anywhere.
...
if (form) {
    ...
    const calculateQuote = () => {
        ...
        return {
            ...
            designerSvg: (typeof designerSvgInput !== 'undefined' && designerSvgInput) ? (designerSvgInput.value || '') : '',
        };
    };
